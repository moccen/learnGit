...
$(function() {
    ...
    var groupHtml = '<div class="content"><div data-widget="tabs" class="m JD-stock" id="JD-stock">' + '<div class="mt">' + '    <ul class="tab">' + '        <li data-index="0" data-widget="tab-item" class="curr" id="groutTab_0"><a href="#none" class="hover"><em>请选择</em></a></li>' + '    </ul>' + '    <div class="stock-line"></div>' + '</div>' + '<div class="mc curr" data-area="0" data-widget="tab-content" id="groupItems_0"></div>' + '</div></div>';
    var exceptionAry = [];

    $("#store-selector .text").after(groupHtml);
    ...
    (function init() {
        ...
        $("#JD-stock .mt .tab li").click(function(e) {
            onTabClick2(this);
        })
        ...
        function onTabClick(tabItem) {
            ...
            if ($(that).attr("class") !== 'curr') {
                $("#JD-stock .mt .tab li").removeClass('curr').hide();
        ...
        function changeSummaryText() {
            ...
            $("#store-selector .text div").html(tabStrs);
        }
    })();
