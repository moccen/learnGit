...
(function(){
	...
	CurrentAreaInfoInit();//初始化当前地域信息

	//var areaTabContainer=$("#JD-stock .tab li")
	areaTabContainer.eq(0).find("a").click(function(){
		areaTabContainer.removeClass("curr");
		areaTabContainer.eq(0).addClass("curr").show();
		provinceContainer.show();//var provinceContainer=$("#stock_province_item");
		cityContainer.hide();//var cityContainer=$("#stock_city_item");
		areaContainer.hide();//var areaContainer=$("#stock_area_item");
		townaContainer.hide();//var townaContainer=$("#stock_town_item");
